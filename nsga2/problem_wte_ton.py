...
class WTE2(Problem):
    ...
    def __init__(self):
        super().__init__(n_var=1, n_obj=2, n_constr=1, type_var=anp.double)
        self.xl = anp.array([500])
        self.xu = anp.array([2400])
        self.vcl = anp.array([712, 2729, 1921, 2490, 8193, 8633])
        self.xi = anp.array([0.62, 0.16, 0.04, 0.01, 0.15, 0.02])
    ...
    def _evaluate(self, x, out, *args, **kwargs):
        ...
        vcl_total = np.flip(vcl_total, axis=0)
